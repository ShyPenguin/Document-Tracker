...
import { removeReturned, setReturned } from "../../reducers/returnedSlice";

function ReturnedView() {
  const dispatch = useDispatch();
  const [startDate, setStartDate] = useState("");
  const [endDate, setEndDate] = useState("");
  const currentPage = useSelector((state) => state.returned.currentPage);
  const numberOfPage = useSelector((state) => state.returned.numberOfPage);
  const documents = useSelector((state) => state.returned.data);
