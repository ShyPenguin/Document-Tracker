...
import { removeIncoming, setIncoming } from "../../reducers/incomingSlice";
import "./incomming.css";

function IncomingView() {
  const dispatch = useDispatch();
  const [startDate, setStartDate] = useState("");
  const [endDate, setEndDate] = useState("");
  const currentPage = useSelector((state) => state.incoming.currentPage);
  const numberOfPage = useSelector((state) => state.incoming.numberOfPage);
