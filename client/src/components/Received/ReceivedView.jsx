...
import { setReceived, removeReceived } from "../../reducers/receivedSlice";

function ReceivedView() {
  const dispatch = useDispatch();
  const [startDate, setStartDate] = useState("");
  const [endDate, setEndDate] = useState("");
  const currentPage = useSelector((state) => state.received.currentPage);
  const numberOfPage = useSelector((state) => state.received.numberOfPage);
