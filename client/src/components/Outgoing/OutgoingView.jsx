...
import { removeOutgoing, setOutgoing } from "../../reducers/outGoingSlice";
import "./outgoing.css";
function OutgoingView() {
  const dispatch = useDispatch();
  const [startDate, setStartDate] = useState("");
  const [endDate, setEndDate] = useState("");
  const currentPage = useSelector((state) => state.outgoing.currentPage);
  const numberOfPage = useSelector((state) => state.outgoing.numberOfPage);
